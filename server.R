               ...
               ifelse(elicitation_method=="quartiles",
                      ...
                      tagList(div(
                        ...
                        fluidRow(column(4,p("Value 1 ", strong("(your lower tertile)"),":")),
                                 column(3, numericInput("tertile1_0", NULL, elici_t1$test, min = elici_minis$test, max = elici_maxis$test))), br(),
                        fluidRow(column(4,p("Value 2 ", strong("(your upper tertile)"),":")),
                                 column(3, numericInput("tertile2_0", NULL, elici_t2$test, min = elici_minis$test, max = elici_maxis$test))), br(),
                        br(),
                        HTML("<div style='height: 70px;width: 600px'>"),
